 ...
 *
 */
#define TEMP_SENSOR_0 1 // This should be the Hot End
#define TEMP_SENSOR_1 0 // Was 1
#define TEMP_SENSOR_2 0 // Was 1
#define TEMP_SENSOR_3 0 // Was 1
